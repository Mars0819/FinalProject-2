...
public class SmartphoneAdapter extends RecyclerView.Adapter<SmartphoneAdapter.ViewRecHolder> {

    private SmartphoneModel[] listData;
    private Context mcontext;

    public SmartphoneAdapter(SmartphoneModel[] listData, Context mcontext) {
    ...
    public ViewRecHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mcontext).
                inflate(R.layout.list_item_smartphone,parent,false);
        return new ViewRecHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewRecHolder holder, int position) {
        final SmartphoneModel smartphoneModel = listData[position];
