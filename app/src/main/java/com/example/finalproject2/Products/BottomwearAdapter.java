...
public class BottomwearAdapter extends RecyclerView.Adapter<BottomwearAdapter.ViewRecHolder> {

    private BottomwearModel[] listData;
    private Context mcontext;

    public BottomwearAdapter(BottomwearModel[] listData, Context mcontext) {
    ...
    public ViewRecHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mcontext).
                inflate(R.layout.list_item_bottomwear,parent,false);
        return new ViewRecHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewRecHolder holder, int position) {
        final BottomwearModel bottomwearModel = listData[position];
