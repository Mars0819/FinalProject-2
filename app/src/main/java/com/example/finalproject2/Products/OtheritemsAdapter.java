...
public class OtheritemsAdapter extends RecyclerView.Adapter<OtheritemsAdapter.ViewRecHolder> {

    private OtheritemsModel[] listData;
    private Context mcontext;

    public OtheritemsAdapter(OtheritemsModel[] listData, Context mcontext) {
    ...
    public ViewRecHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mcontext).
                inflate(R.layout.list_item_otheritems,parent,false);
        return new ViewRecHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewRecHolder holder, int position) {
        final OtheritemsModel otheritemsModel = listData[position];
