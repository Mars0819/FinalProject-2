...
public class BooksAdapter extends RecyclerView.Adapter<BooksAdapter.ViewRecHolder> {

    private BooksModel[] listData;
    private Context mcontext;

    public BooksAdapter(BooksModel[] listData, Context mcontext) {
    ...
    public void onBindViewHolder(@NonNull ViewRecHolder holder, int position) {
        final BooksModel booksModel = listData[position];
